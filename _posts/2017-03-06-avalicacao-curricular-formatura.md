...
Requisitos necessários para a integralização curricular:
  ...
  • Cumprir carga horária mínima de atividades complementares definidas no currículo do
  curso.
  • Aprovação em Trabalho de Conclusão de Curso (TCC, Monografia) definido no currículo do
  curso.
  • Situação quanto ao ENADE – Exame Nacional de Desenvolvimento Estudantil (data de
  participação ou dispensa de acordo com art. 33-G da Portaria Normativa nº 40 de 12/12/2007).
...
- NAC (Núcleo de Avaliação Curricular):
  ...
  1. Avaliar e liberar no SIAC (Sistema Acadêmico) os estudantes
  concluintes;
...
* Em caso de Validação:

  NAC realiza pré-avaliação curricular, por meio do SIAC, e aguarda o envio das fichas de avaliação curricular pelos(as) Coordenadores(as) de Colegiado.

* Em caso de Não Validação:

  Aguarda o Colegiado enviar a lista oficial de concluintes.
